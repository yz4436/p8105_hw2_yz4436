...
Clean and tidy unemployment.csv to let it can be merged with previous documents. I used pivot_longer to switching it from “wide” to “long” format and ensured that key variables have the same name and key variables take the same values.
```{r}
unemployment_df = 
  read_csv(
