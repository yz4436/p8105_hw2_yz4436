...
Clean the data in pols-month.csv. Then I break up mon into year, month, and day. Then I use recode function to change month number to month name, and create a new variable called president to show dem or gop as value. Finally, remove prez_gop, prez_dem, and day.
```{r}
pols_month_df = 
  read_csv(
